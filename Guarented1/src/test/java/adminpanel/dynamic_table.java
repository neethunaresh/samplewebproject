...
*/
 ...
 public void Handle_Dynamic_Webtable() {
  ...
  for (int row=0; row<rows_count; row++){
   ...
   Object text=driver.findElement(By.id("sdsdd")).getText();
  // Assert.assertTrue(isElementPreset(text, driver));
   ...
   System.out.println("--------------------------------------------------");
	...
	public  static boolean isElementPreset(By object,WebDriver driver) {
 ...
 public  void mainguj() {
	...
	// isElementPreset(text), "actionName is missing!!");
